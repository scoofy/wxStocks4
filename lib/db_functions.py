import wx
import config
import inspect, logging, os, threading, hashlib, glob
...
ticker_path = 'db_data/ticker.pk'
all_stocks_path = 'db_data/all_stocks_dict.pk'
all_attributes_path = 'db_data/all_attributes_set.pk'
screen_dict_path = 'db_data/screen_dict.pk'
named_screen_path = 'db_data/screen-%s.pk'
...
try:
    ...
    os.mkdir(portfolio_startup_check)
...
encryption_strength_path = 'db_data/encryption_strength.txt'
